# CLAUDE.md — cloudsmith-agent

Claude Code context for `cloudsmith-agent` — one of the code repos in the CloudSmith open-source project.

## What this repo is

Runner daemon (Windows Service) — mTLS enrollment, job dispatch, and WinRM/Redfish payload execution
